...
:::note 省力化コンポーネントの導入に向いているシステム

バックオフィス系のシステムは、前述の4つの条件に当てはまる画面が多いため導入効果が高い傾向にあります。
:::
...
:::note 省力化コンポーネントの導入に向いていないシステム
コンシューマー向けのシステムは、前述の4つの条件に当てはまる画面が多いため、導入効果が得られにくい傾向にあります。
:::
